...
def write_txt(team1,team1_id, team2, team2_id):
    ...
    file_name = "{:s}{:s}_FSN.txt".format(team1_abbr.upper(),team2_abbr.upper())
...
#write_txt(heat_q,spurs_q)
#write_txt(kings_q,raptors_q)
#write_txt(lakers_q, timberwolves_q)